...
import main.model.*;
import main.utils.NumberFilter;
...
public class MenuPanel extends JMenuBar {
    ...
    private Consumer<List<PosterElement>> loadElementsCallback;
    private Function<Void, List<PosterElement>> saveElementsCallback;
    ...
    private void exportImage() {
        ...
        JCheckBox includeAllElements = new JCheckBox("Include all elements", true);

        JPanel sizePanel = new JPanel(new FlowLayout(FlowLayout.LEFT));
        sizePanel.add(new JLabel("Width:")); sizePanel.add(widthField);
        sizePanel.add(new JLabel("Height:")); sizePanel.add(heightField);
        sizePanel.add(includeAllElements);
        ...
        buttonPanel.add(createButton("OK", e -> {
            exportToFile(dialog, filePathField.getText(), widthField, heightField, includeAllElements.isSelected());
        }));
    ...
    private void exportToFile(JDialog dialog, String path, JTextField widthField, JTextField heightField, boolean includeAll) {
        if (path.isEmpty()) return;
        try {
            int width = Integer.parseInt(widthField.getText());
            int height = Integer.parseInt(heightField.getText());
            BufferedImage image = posterPanel.getImage(width, height, includeAll);
    ...
    public void setLoadElementsCallback(Consumer<List<PosterElement>> callback) {
        this.loadElementsCallback = callback;
    }
}
