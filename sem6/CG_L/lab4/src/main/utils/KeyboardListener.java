...
public class KeyboardListener implements KeyListener {
    ...
    private void moveUp() { selectedElement.move(0, -1);  runCallbacks();}
    private void moveDown() { selectedElement.move(0, 1);  runCallbacks();}
    private void rotateLeft() { selectedElement.rotate(-Math.toRadians(1));  runCallbacks();}
    private void rotateRight() { selectedElement.rotate(Math.toRadians(1));  runCallbacks();}
    private void scaleUp() { selectedElement.scale(1.05,1.05);  runCallbacks();}
    private void scaleDown() { selectedElement.scale(0.95,0.95);  runCallbacks();}
