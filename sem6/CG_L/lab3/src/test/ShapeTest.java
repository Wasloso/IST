...
class ShapeTest {
    ...
    void testInvalidDeserialization_UnknownShape() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> Shape.deserialize(data));
    ...
    void testInvalidDeserialization_MalformedData() {
        ...
        Exception exception = assertThrows(InvalidParameterException.class, () -> Shape.deserialize(data));
