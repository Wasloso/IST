...
public abstract class Shape extends JComponent {
    ...
    public static Shape deserialize(final String data) {
        ...
        if(parts.length != 8) throw new InvalidParameterException("Invalid arguments for shape deserialization");
    ...
    public static Shape fromShapeType(ShapeType type, final Point start, final Point end, final int r, final int g, final int b) {
        return switch (type) {
