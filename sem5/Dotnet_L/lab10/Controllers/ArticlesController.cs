...
namespace lab10.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Price,CategoryId")] Article article)
        {
            if (id != article.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (article != null)
            {
                if (article.ImagePath != null)
                {
                    ...
                    if (System.IO.File.Exists(fullPath) && article.ImagePath != "default.jpg")
                    {
